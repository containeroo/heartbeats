...
type MSTeamsConfig struct {
	...
	TitleTmpl  string `yaml:"title_tmpl,omitempty"` // TitleTmpl is the title template for the notification.
	TextTmpl   string `yaml:"text_tmpl,omitempty"`  // TextTmpl is the text template for the notification.
}
